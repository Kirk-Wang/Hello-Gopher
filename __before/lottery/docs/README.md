...
- 根据发奖计划填充奖品池，保证奖品可以有节奏的发放出去

### 前端大转盘页面 ajax 调用服务端接口
...
- 同一个 IP 得到多次大奖，同一个用户得到多次大奖，合理吗？
- 奖品集中在一个较短的时段内全部发放出去，合理吗？
- 所有用户获得大奖的概率一样，合理吗？

### 压力测试

更多的性能对比，wrk -t10 -c10 -d5 "http://**"

- 对比，不同的奖品数量，不同的中奖概率
- 对比，用户今日抽奖次数限制，IP 今日抽奖次数限制
- 分析程序的资源调用，了解时间都去哪里了
